...
% Use an acronym - odkomentujte po inštalácii glossaries balíčka
...
Príklad použitia skratiek (UML, OCL, BPMN) - odkomentujte \textbackslash gls\{\} príkazy po inštalácii glossaries.
...
% Add citations - odkomentujte po inštalácii biblatex balíčka
\newpage
\noindent
...
Pre citácie používajte normu STN ISO 690, môžete citovať aj v tvare [1], [2],… vtedy v zozname literatúry neuvádzate zdroje abecedne, ale ich uvádzate podľa poradia výskytu v texte. Odkomentujte príkazy \textbackslash parencite\{\} a \textbackslash textcite\{\} po inštalácii biblatex. 
