...
% Veľkosti nadpisov ako v predlohe (jemne menšie než default article class)
\makeatletter
...
% Prisma schema language (PostgreSQL ORM DSL)
\lstdefinelanguage{Prisma}{%
  ...
  keywordstyle=[2]\color{teal!60!black}\bfseries,
