...
% Každá hlavná kapitola (\section) začína na novej strane; nadpisy v UPPERCASE
% (podľa referenčnej predlohy: "1 ÚVOD", "1.1 SYSTÉM KVALITY")
\usepackage{xparse}
...
% Nadpis "Obsah" + nadpisy zoznamov — BOLD veľký, podľa referencie
\renewcommand{\contentsname}{Obsah}
\makeatletter
\renewcommand{\tableofcontents}{%
  \par\noindent{\Large\bfseries\contentsname}\par\vspace{1em}%
...
\makeatletter
% Nadpisy zoznamov: BOLD large (zhodný štýl ako "Obsah")
\renewcommand{\listoffigures}{%
  \par\noindent{\Large\bfseries\listfigurename}\par\vspace{1em}%
  \@starttoc{lof}}
\renewcommand{\listoftables}{%
  \par\noindent{\Large\bfseries\listtablename}\par\vspace{1em}%
  \@starttoc{lot}}
\makeatother
\listoffigures
...
\noindent{\Large\bfseries Zoznam skratiek a značiek}\par\vspace{1em}
